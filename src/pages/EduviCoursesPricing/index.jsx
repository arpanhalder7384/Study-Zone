...
export default function EduviCoursesPricingPage() {
  return (
    <>
      <Helmet>
        <title>Arpan's Application4</title>
        ...
        <div className="flex flex-row justify-center w-full">
          <div className="flex flex-row justify-center w-full md:px-5 max-w-7xl">
            <div className="flex flex-row md:flex-col items-center w-full gap-10 md:gap-2.5">
              <div className="flex flex-col items-start justify-start w-[32%] md:w-full gap-6 p-[30px] sm:p-5 bg-white-A700 cursor-pointer rounded-[20px] hover:shadow-md">
              ...
              <div className="flex flex-col items-start justify-start w-[32%] md:w-full gap-6 p-[30px] sm:p-5 bg-white-A700 shadow-md cursor-pointer rounded-[20px] hover:shadow-md">
